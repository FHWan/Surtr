...
#define LED_Bule 	PDout(12)	//白光
#define LED_Red 	PDout(13)	//红光
...
#define START_STK_SIZE                  256     /* 堆栈大小 */
...
#define EC20_GET_STK_SIZE                   256     /* 堆栈大小 */
...
#define SERVO_STK_SIZE                   256     /* 堆栈大小 */
...
#define BATTERY_STK_SIZE                   256     /* 堆栈大小 */
...
#define LIGHT_STK_SIZE                   256     /* 堆栈大小 */
...
#define BELED_STK_SIZE                   256     /* 堆栈大小 */
...
void Light_task(void *p_arg)
{
    while (1)
    {
		Lux=Get_Adc_Average(ADC_CHANNEL_11,20);				//获取ADC值
		Lux=(4050-Lux) / 10;
		if(Lux<=0)	Lux=0;
