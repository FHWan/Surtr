...
struct xmsg_device_list_
{
  ...
  _dev_count_type dev_count;
   ...
   typedef std::vector< ::xpkg_comm::xmsg_device_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::xpkg_comm::xmsg_device_<ContainerAllocator> >> _dev_list_type;
