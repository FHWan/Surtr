...
class Follower:
	...
	if self.nav_init == True:
        ...
        if self.nav_init == False:
            if self.cam_msg.data == "0" and T3 >= 19:   #第一个大厦
                self.cam_msg.data = "1"
            elif self.cam_msg.data == "1" and T3 >= 44: #人群
                self.cam_msg.data = "2"
        else:
            if part != 4 and self.cam_msg.data == "2" and T3 >= 13: #第二个大厦
                self.cam_msg.data = "3"
            elif self.cam_msg.data == "2" and T3 >= 15.5: #第二个大厦
                self.cam_msg.data = "3"
		...
		if self.nav_init == True and T3 >= 14 and part == 3:
		...
		#self.twist.linear.x = 0.3
		#self.twist.angular.z = 0
        if self.nav_init == True and part == 4:
            if T3 <= 4.2:
                self.twist.linear.x = 0.15
                self.twist.angular.z = 0        
            elif T3 <= 12.9:
                self.twist.linear.x = 0.15
                self.twist.angular.z = 0.183
            elif T3 <= 17:
                self.twist.linear.x = 0.15
                self.twist.angular.z = 0
            elif T3 <= 19:
